...
![A screenshot of a
computer](.\media\Lab-02/media/image5.png){width="2.4719160104986875in"
...
menu](.\media\Lab-02/media/image6.png){width="1.8299245406824147in"
...
generated](.\media\Lab-02/media/image7.png){width="1.614808617672791in"
...
4.  A window will open that will allow you to select a source for our
    ...
    "Azure Event Hubs".\
    \
    ![](.\media\Lab-02/media/image8.png){width="6.506944444444445in"
...
5.  You are now required to create a connection to the Azure Event Hub.
    ...
    \
    ![A screenshot of a
    computer](.\media\Lab-02/media/image9.png){width="3.4948501749781276in"
...
7.  Once all properties have been filled out click on **Connect**.\
    ...
    generated](.\media\Lab-02/media/image10.png){width="4.9191579177602796in"
...
8.  In the configuration of the Azure Event Hub data source, you may
    ...
    \
    ![A screenshot of a
    computer](.\media\Lab-02/media/image11.png){width="5.799681758530184in"
...
9.  Before we finalize this data source and Eventstream, let's go ahead
    ...
    **![A screenshot of a
    computer](.\media\Lab-02/media/image12.png){width="2.1525546806649167in"
...
10. Now we can click on **Next**, which will take us to a final overview
    ...
    \
    ![A screenshot of a
    computer](.\media\Lab-02/media/image13.png){width="1.436994750656168in"
...
11. In this overview screen, verify the contents look correct and click
    ...
    **\
    ![A screenshot of a computer Description automatically
    generated](.\media\Lab-02/media/image14.png){width="3.848911854768154in"
...
12. Once the Eventstream and Eventstream source are created select the
    ...
    \
    ![A screenshot of a
    computer](.\media\Lab-02/media/image15.png){width="3.055896762904637in"
...
![](.\media\Lab-02/media/image16.png){width="6.2590715223097115in"
height="1.971240157480315in"}

15. You should now see a sample of the data within the bottom window.\
    ![A screenshot of a
    computer](.\media\Lab-02/media/image17.png){width="4.631952099737533in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image18.png){width="5.133778433945757in"
...
1.  Click on the tile within the canvas area labeled "Switch to edit
    ...
    \
    ![A screenshot of a
    computer](.\media\Lab-02/media/image19.png){width="4.834008092738408in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image20.png){width="2.2601399825021873in"
...
generated](.\media\Lab-02/media/image21.png){width="1.3973228346456692in"
...
> ![A screenshot of a computer Description automatically
> generated](.\media\Lab-02/media/image22.png){width="1.9273523622047244in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image23.png){width="2.8298053368328957in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image24.png){width="2.411363735783027in"
...
![A screenshot of a
chat](.\media\Lab-02/media/image25.png){width="5.878044619422572in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image26.png){width="6.506944444444445in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image27.png){width="5.957354549431321in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image28.png){width="3.3650524934383204in"
...
12. You may need to update your **"Data connection name"** to meet
    ...
    **"eh_Fabrikam_es_InternetSales".** Then we can click on **Next.\
    \
    **![A screenshot of a
    computer](.\media\Lab-02/media/image29.png){width="4.927771216097987in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image30.png){width="5.978159448818897in"
...
![A screen shot of a
computer](.\media\Lab-02/media/image31.png){width="5.947115048118985in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image32.png){width="3.946890857392826in"
height="2.202706692913386in"}

2.  Open the **eh_Fabrikam** KQL Database item.

![A screenshot of a
computer](.\media\Lab-02/media/image33.png){width="4.061921478565179in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image34.png){width="6.171492782152231in"
height="2.572004593175853in"}

4.  Click on the **refresh icon** in the top-right corner of the screen.

![A screenshot of a
phone](.\media\Lab-02/media/image35.png){width="5.891737751531059in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image36.png){width="3.0316732283464565in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image37.png){width="2.0744149168853894in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image38.png){width="6.506944444444445in"
height="2.2055555555555557in"}

8.  Click on **Explore your data** in the top-right corner.

![A white background with black text Description automatically
generated](.\media\Lab-02/media/image39.png){width="6.506944444444445in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image40.png){width="6.506944444444445in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image41.png){width="6.506944444444445in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image42.png){width="2.1878051181102363in"
...
![](.\media\Lab-02/media/image43.png){width="5.39198053368329in"
...
generated](.\media\Lab-02/media/image44.png){width="3.8963768591426073in"
...
14. Highlight **Line 12 and 13** and click on the **Run** button in the
    ...
    \
    ![A screenshot of a
    computer](.\media\Lab-02/media/image45.png){width="2.534669728783902in"
...
> ![A screenshot of a computer Description automatically
> generated](.\media\Lab-02/media/image46.png){width="2.173869203849519in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image47.png){width="6.15280949256343in"
...
1.  You need to create a query that returns the number of each product
    ...
    **(Note: Double click the object below in order to be able to copy
    the text)\
    **\
    ![](.\media\Lab-02/media/image48.emf)

![](.\media\Lab-02/media/image49.png){width="1.4205325896762904in"
...
2.  The comment line "\--" followed by the keyword "explain" will allow
    ...
    like:\
    \
    ![](.\media\Lab-02/media/image50.emf)

![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image51.png){width="5.583232720909886in"
...
> ![A screenshot of a computer Description automatically
> generated](.\media\Lab-02/media/image52.png){width="4.750662729658792in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image53.png){width="6.506944444444445in"
...
![A screenshot of a
computer](.\media\Lab-02/media/image54.png){width="6.506944444444445in"
height="1.44375in"}
...
![A screenshot of a
computer](.\media\Lab-02/media/image55.png){width="6.506944444444445in"
...
generated](.\media\Lab-02/media/image56.png){width="4.858754374453193in"
...
![A screenshot of a computer
code](.\media\Lab-02/media/image57.png){width="3.8330030621172355in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image58.png){width="4.427701224846894in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image59.png){width="4.490209973753281in"
...
![A screenshot of a computer Description automatically
generated](.\media\Lab-02/media/image60.png){width="2.6774573490813647in"
...
4.  In the future if we would like to isolate our code, we can simply
    ...
    \
    ![A screenshot of a computer Description automatically
    generated](.\media\Lab-02/media/image61.png){width="2.6774573490813647in"
    height="1.9794433508311462in"}
...
![A screenshot of a
computer](.\media\Lab-02/media/image62.png){width="4.516534339457568in"
